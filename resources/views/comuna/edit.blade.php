    ...
    <div class="container">
        ...
        <form method="POST" action="{{ route('comunas.update', ['comuna' => $comuna->comu_codi]) }}">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="id" aria-describedby="codigotelp" name="id"
                    disabled="disabled" value="{{ $comuna->comu_codi }}">
                <div id="codigotelp" class="form-text">Commune Id.</div>
            </div>
            <div class="mb-3">
                <label for="name" class="form-label">Commune</label>
                <input type="text" required class="form-control" id="name" placeholder="Commune name" name="name"
